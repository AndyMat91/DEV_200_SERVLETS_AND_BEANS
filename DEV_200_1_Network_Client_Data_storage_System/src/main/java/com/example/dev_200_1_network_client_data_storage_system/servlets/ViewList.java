...
import com.example.dev_200_1_network_client_data_storage_system.beans.SelectBean;
import com.example.dev_200_1_network_client_data_storage_system.security.AuthorizationBean;
...
public class ViewList extends HttpServlet {
    ...
    private void getPage(PrintWriter out) {
        ...
        selectBean.findAllClient().forEach(client -> {
            ...
            out.println("<td><a href=\"http://localhost:8080/DEV_200_1_Network_Client_Data_storage_System-1.0-SNAPSHOT/Update?client-id=" + client.getClientId() + "&name=CreateAddress\">добавить адрес клиенту</a></td>\n");
            out.println("<td><a href=\"http://localhost:8080/DEV_200_1_Network_Client_Data_storage_System-1.0-SNAPSHOT/Delete?client-id=" + client.getClientId() + "&name=DeleteAddress&mac=" + client.getMac() + " \">удалить адрес</a></td>\n");
            out.println("<td><a href=\"http://localhost:8080/DEV_200_1_Network_Client_Data_storage_System-1.0-SNAPSHOT/Update?client-id=" + client.getClientId() + "&name=UpdateClient\">изменить данные о клиенте</a></td>\n");
            out.println("<td><a href=\"http://localhost:8080/DEV_200_1_Network_Client_Data_storage_System-1.0-SNAPSHOT/Update?client-id=" + client.getClientId() + "&name=UpdateAddress&mac=" + client.getMac() + " \">изменить адрес</a></td>\n");
            out.println("</tr>\n");
        });
        tail(out);
    }
